...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "b7bf930f-5d2a-4632-9b23-a3f1e44173fc");
    ...
    if (data.success) {
      setResult("");
      toast.success("Form submitted successefuly")
      event.target.reset();
    } else {
...
<div className="my-6 text-left">
  Message
    <textarea name="Message" placeholder="Message" required className="w-full border border-gray-300 rounded py-3 px-4 mt-2 h-48 resize-none">
    </textarea>
</div>
